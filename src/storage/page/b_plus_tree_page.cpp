...
auto BPlusTreePage::IsOverflow() const -> bool { return size_ > max_size_; }
auto BPlusTreePage::IsUnderflow() const -> bool { return size_ < GetMinSize(); }
/*
 * Helper method to get min page size
 * Generally, min page size == max page size / 2
 * But whether you will take ceil() or floor() depends on your implementation
 */
auto BPlusTreePage::GetMinSize() const -> int { return std::floor(max_size_ / 2); }
